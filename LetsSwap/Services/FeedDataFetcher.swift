...
struct NetworkDataFetcher: FeedDataFetcher {
    private var feedItems = [
        ...
        FeedItem(orderId: 10, title: "Научу кататься на борде", description: "Катаю с детства, знаю огромное количество трюков, обожаю фрирайд ", counterOffer: "Научите меня серфить", isFavourite: true, isFree: false, date: 4198267346, photo: nil),
