...
struct NetworkDataFetcher: FeedDataFetcher {
    ...
    private var getFeedUrl = URL(string: "\(ServerAddressConstants.MAIN_SERVER_ADDRESS)/security/order/feed/getFeed")
    private var getFiltredFeedUrl = URL(string: "\(ServerAddressConstants.MAIN_SERVER_ADDRESS)/security/order/search")
    private var getFavoriteOrdersFeedUrl = URL(string: "\(ServerAddressConstants.MAIN_SERVER_ADDRESS)/security/order/favorite/getFavorite")
    func getFavoriteOrdersFeed(nextBatchFrom: String?, completion: @escaping (Result<FeedResponse, FeedError>) -> Void) {
    ...
    func getOrder(orderId: Int, completion: @escaping (Result<OrderResponse, OrderError>) -> Void) {
        guard let url = URL(string: "\(ServerAddressConstants.MAIN_SERVER_ADDRESS)/security/order/feed/getOrderFeed/\(orderId)")  else {
    ...
    func getAlienProfile(userId: Int, completion: @escaping (Result<FullProfileResponse, AlienProfileError>) -> Void) {
        ...
        guard let url = URL(string: "\(ServerAddressConstants.MAIN_SERVER_ADDRESS)/security/user/getProfile") else {
