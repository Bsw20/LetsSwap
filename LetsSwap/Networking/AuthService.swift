...
struct AuthService {
    ...
    private static var sendSmsUrl = URL(string: "http://178.154.210.140:3000/smsSend")
    private static var signUpUrl = URL(string: "http://178.154.210.140:3000/register")
    private static var signInUrl = URL(string: "http://178.154.210.140:3000/login")
